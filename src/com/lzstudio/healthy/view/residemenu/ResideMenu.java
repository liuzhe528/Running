package com.lzstudio.healthy.view.residemenu;
...
public class ResideMenu extends FrameLayout {
	...
	private void initViews(Context context) {
		...
		loginStatus = (LinearLayout) findViewById(R.id.ll_login_status);
		iv_login_head = (ImageView) findViewById(R.id.iv_login_head);
		tv_login_username = (TextView) findViewById(R.id.tv_login_username);
	}

	public LinearLayout getLoginStatus() {
		return loginStatus;
	}

	public ImageView getHeadImageView() {
		return iv_login_head;
	}

	public TextView getUserNameTextView() {
		return tv_login_username;
	}
